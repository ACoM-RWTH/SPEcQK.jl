...
function convect_1D_LF!(moments_all, dt, dx, max_eigenvalue, N,
                       ...
                       n_v, mmm_constraint, mmm_all, w, Δv, λ,
    ...
    compute_constraint_matrix!(A, mmm_constraint, w, n, m_constraint)
    ...
    @inbounds for step in 1:N
        for cell in 1:n_cells
            ...
            compute_moments_from_vdf!(view(moments_work, :, cell), gsol, w, mmm_all, n, m_all)
        end
